...
*/
    ...
    try {
        if (array_key_exists('DOCUMENT_ROOT',$_SERVER) && $_SERVER['DOCUMENT_ROOT']!=='') {
            ...
            //echo '<pre>'; var_dump ($dcFolderName); echo '</pre>'; die();
    ...
    $lanConfigFilepath = realpath(dirname(__FILE__).'/../../../domains/'.$naWebOS->domainFolder).'/domainConfig/naLAN.json';
    $lanConfigExampleFilepath = realpath(dirname(__FILE__).'/../../../domains/'.$naWebOS->domainFolder).'/domainConfig/naLAN.EXAMPLE.json';
