...
<script type="module">
//import { naLogo } from '/NicerAppWebOS/na.canvasLogo-4.y.z.js?f=u';
</script>
{$cssLinks}
{$pageSpecificCSS}
{$javascriptLinks}
...
<body onload="siteOnLoad()">
    ...
    <div id="siteTaskbar" class="vividDialog naTaskbar">
      <div class="vividDialogBackground1"></div>
      <video src="https://{$domain}/siteMedia/videos/output1.webm"
        preload="none"
      ...
      <canvas></canvas>
      <video src="https://{$domain}/siteMedia/videos/output3.webm"
        preload="none"
    ...
    <div id="siteSettingsMenu" class="vividDialog naStartMenu hidden">
      <div class="vividDialogBackground1"></div>
        <?php
        echo $naWebOS->html_vividButton (
            4, 'position:relative;',
...
echo $naWebOS->html_vividButton (
    ...
    <div id="btnOptions_menu" class="vividDialogPopup anchored vividScrollpane" style="z-index:-10;overflow:visible;"
        ...
        //onmouseover="na.site.onmouseover_btnOptions(event);" onmouseout="na.site.onmouseout_btnOptions(event)"
            global $naWebOS;
            $fn = realpath(dirname(__FILE__).'/../../../').'/domainConfig/'.$naWebOS->domainFolder.'/btnOptions_menu__default.php';
