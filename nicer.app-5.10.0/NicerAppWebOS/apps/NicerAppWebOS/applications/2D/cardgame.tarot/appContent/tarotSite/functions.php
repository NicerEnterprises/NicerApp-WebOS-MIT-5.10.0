...
function t2_getDecksFromFilesystem() {
	...
	foreach ($p as $idx => $path) {
		...
		//var_dump($path);exit();
		$path = str_replace('/home/rene/data1/htdocs/nicer.app/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/', '', $path);
		$path = str_replace('/var/www/nicer.app/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/', '', $path);
		$path = str_replace('/var/www/nicer.app/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/', '', $path);
...
function t2_html_deck_info () {
	...
	if (file_exists($xmlFile)) {
		...
		if (file_exists('/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/'.$cd.'/box.jpg')) $r .= t2_html_deck_box('box.jpg',$cd);
		if (file_exists('/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/'.$cd.'/box1.jpg')) $r .= t2_html_deck_box('box1.jpg',$cd);
		if (file_exists('/NicerAppWebOS/apps/NicerAppWebOS/applications/2D/cardgame.tarot/appContent/tarotSite/decks/'.$cd.'/box2.jpg')) $r .= t2_html_deck_box('box2.jpg',$cd);
		$r .= '</td></tr></table>';
	} else {
