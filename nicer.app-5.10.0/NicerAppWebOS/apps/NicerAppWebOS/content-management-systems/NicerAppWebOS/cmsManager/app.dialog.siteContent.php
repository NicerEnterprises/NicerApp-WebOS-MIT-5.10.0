    ...
    //setTimeout (function() {
        ...
        */
            ...
            tinymce.init({
                ...
                content_css: [
                    '/NicerAppWebOS/3rd-party/tinymce-4/themes/charcoal/content.min.css?now='+(new Date().getTime()),
                    ...
                    '/NicerAppWebOS/3rd-party/tinymce-4/themes/charcoal/content.na.css?now='+(new Date().getTime()),
                    '/domainConfig/'+na.site.globals.domainFolder+'/index.css?now='+(new Date().getTime()),
                    '/domainConfig/'+na.site.globals.domainFolder+'/index.dark.css?now='+(new Date().getTime())
                ],
